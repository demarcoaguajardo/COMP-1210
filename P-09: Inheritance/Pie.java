...
public class Pie extends BakedItem {
   ...
   /**
    * Creates method that compares Pie objects.
    * @param item representing item being compared to Pie object.
    * @return int representing value of comparison.
    */
   public int compareTo(Pie item) {
      return this.toString().toUpperCase().compareTo(item.
