...
//    /** A test that always fails. **/
   ...
   @Test public void setLabelTest() {
      ...
      Assert.assertTrue(obj1.setLabel("New"));
      
      RingTorus obj2 = new RingTorus("Old2", 2.0, 1.0);
      Assert.assertFalse(obj2.setLabel(null));    
   }
   ...
   @Test public void setLargeRadiusTest() {
      RingTorus obj1 = new RingTorus("Old", 2.0, 1.0);
      Assert.assertTrue(obj1.setLargeRadius(3.0));
      
      RingTorus obj2 = new RingTorus("Old 2", 4.0, 2.0);
      Assert.assertTrue(obj2.setLargeRadius(3.0));
      
      RingTorus obj3 = new RingTorus("Old 3", 4.0, 3.0);
      Assert.assertFalse(obj3.setLargeRadius(2.0));
      
      RingTorus obj4 = new RingTorus("Old 4", 2.0, 1.0);
      Assert.assertFalse(obj4.setLargeRadius(-3.0));
   }
   ...
   @Test public void setSmallRadiusTest() {
      RingTorus obj1 = new RingTorus("Old", 2.0, 1.0);
      Assert.assertTrue(obj1.setSmallRadius(0.5));
      
      RingTorus obj2 = new RingTorus("Old 2", 2.0, 1.0);
      Assert.assertFalse(obj2.setSmallRadius(3.0));
      
      RingTorus obj3 = new RingTorus("Old 3", 2.0, 1.0);
      Assert.assertFalse(obj3.setSmallRadius(-1.0));
   }
   ...
   @Test public void toStringTest() {
      ...
      Assert.assertEquals("RingTorus " + "\"Old\"" + "\n\t"
         ...
         + "volume = 293.004 cubic units", obj1.toString());
   }
   ...
   @Test public void equalsTest() {
      ...
      Assert.assertFalse(obj7.equals(obj8));
      
      RingTorus obj9 = new RingTorus("Old", 2.0, 1.0);
      String obj10 = "not a torus";
      Assert.assertFalse(obj9.equals(obj10));
   }
   ...
   @Test public void compareToTest() {
      ...
      RingTorus obj3 = new RingTorus("Old 2", 1.0, 0.5);
      obj3.volume();
      
      RingTorus obj4 = new RingTorus("Old 2", 2.0, 1.0);
      obj4.volume();
      
      Assert.assertTrue(obj3.compareTo(obj4) < 0);
      
      RingTorus obj5 = new RingTorus("Old 2", 4.0, 1.0);
      obj5.volume();
      
      RingTorus obj6 = new RingTorus("Old 2", 2.0, 1.0);
      obj6.volume();
